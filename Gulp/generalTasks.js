...
gulp.task('build:inject', function() {
    ...
    return gulp
        ...
        .pipe(inject(gulp.src([config.build + 'vendor/angular.js', config.build + 'vendor/jquery.js', config.build + 'vendor/**/*.js'], {read:false}), {name: 'bower', ignorePath: config.build.replace('.', ''), addRootSlash: false}))
